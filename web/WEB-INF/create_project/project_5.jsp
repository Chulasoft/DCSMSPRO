                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="top: 72px">
                    <div class="row">
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false" style="height: 70vh;">
                            <!-- Wrapper for slides -->
                            <form action="CustomerAns" method="POST">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <%
                                        ...
                                        for (int i = 0; i < allCriteria.size(); i++) {
                                            for (int y = i + 1; y < allCriteria.size(); y++) {
                                                Model a = allCriteria.get(i);
                                                Model b = allCriteria.get(y);
                                                if (z == 0) {
                                    %>
                                            ...
                                            <div class="col-lg-offset-1 col-lg-10" style="text-align: center">
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" style="text-align: left"><%=a.getCri_name()%></div>
                                                        <div class="panel-body"><%=a.getCri_des()%></div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    VS
                                                ...
                                                <div class="col-lg-5">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading" style="text-align: left"><%=b.getCri_name()%></div>
                                                        <div class="panel-body"><%=b.getCri_des()%></div>
                                                    </div>
                                                </div>
