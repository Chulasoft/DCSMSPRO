                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-sm-offset-1">
                            <div class="list-group" id="list1">
                                <a href="#" class="list-group-item active">Related Alternative<input title="toggle all" type="checkbox" class="all pull-right"></a>
                                    <%
                                        ArrayList<Integer> listproAL = (ArrayList) request.getAttribute("listproAL");
                                        ...
                                        for (String a : al_name_want) {
                                            if(!listproAL.contains(array_al_id.get(i))){
                                    %>
                        ...
                        <div class="col-sm-4">
                            <form action="EditProject" method="POST">
                                ...
                                <input type="hidden" name="fromEditPage" value="ss"/>
                        ...
                        <div class="col-sm-12" style="margin-top: 10px">
                            <ul class="pager">
                                <li><button type="button" onclick="document.forms[0].submit()" class="btn btn-default"><span class="glyphicon glyphicon-floppy-disk"></span> Save</button></li>
                            </ul>
                        </div>
                    </div>
                </div>
